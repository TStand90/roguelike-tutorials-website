...
room we create. Modify the function like this:
...
So all we're doing is "skipping" the player's turn. Easy! You could do a
number of things here, like giving the player back 1 HP for waiting, but
I won't do that because I'm cruel and unforgiving.
